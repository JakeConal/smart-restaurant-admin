...
import { User, Mail, Table2, MoreVertical, Edit2, Trash2, PauseCircle, PlayCircle } from 'lucide-react';
...
interface WaiterCardProps {
  ...
  onSuspend: (waiter: Waiter) => void;
}

export const WaiterCard: React.FC<WaiterCardProps> = ({
  waiter,
  onEdit,
  onDelete,
  onSuspend,
    ...
    <div className="bg-white rounded-[1.75rem] border border-slate-200/10 shadow-md hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.005] transition-all duration-300 p-6 flex flex-col gap-4 group relative">
      ...
      <div className="flex justify-between items-start">
        <div className="flex items-center gap-3">
          ...
          {/* Name & Email */}
          <div>
            <h4 className="text-xl font-bold text-gray-900">{waiter.full_name}</h4>
      ...
      <div className="mt-auto pt-4 border-t border-gray-50 flex gap-2 opacity-50 group-hover:opacity-100 transition-opacity relative">
        ...
        <button
          ...
          disabled={waiter.status === 'DELETED'}
        >
