    ...
    <div className="min-h-screen bg-ivory-100 flex flex-col items-center justify-center p-6 isolate relative">
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-4 mb-4 relative z-20">
          ...
          <p className="text-caption tracking-widest text-slate-400 font-bold">
            Premium Ordering
          </p>
        </div>
        ...
        <div className="bento-card relative z-30">
            ...
            {activeTab === "signup" && (
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-caption !text-[10px]">
                    First Name
                  </label>
                  <input
                    type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <svg
                className="w-5 h-5 group-hover:scale-110 transition-transform text-slate-400 group-hover:text-slate-600"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="bento-card max-w-sm w-full text-center space-y-8 py-10">
            ...
            <div className="space-y-2">
              ...
              <p className="text-body text-slate-500">
                We've dispatched a secure link to <br />
